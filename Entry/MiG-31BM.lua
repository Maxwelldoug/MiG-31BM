MiG_31BM = {
	...
	SFM_Data = {
		aerodynamics = {
			...
			kjz = 0.00125,
			table_data = {
                { 0,   0.025, 0.07,  0.155, 0.13, 0.5, 30, 1.2 },
                { 0.2, 0.025, 0.07,  0.155, 0.13, 1.5, 30, 1.2 },
                { 0.4, 0.025, 0.07,  0.155, 0.13, 2.5, 30, 1.2 },
                { 0.6, 0.025, 0.073, 0.155, 0.13, 3.5, 30, 1.2 },
                { 0.7, 0.025, 0.076, 0.155, 0.13, 3.5, 28.666666666667, 1.18 },
                { 0.8, 0.025, 0.079, 0.155, 0.13, 3.5, 27.333333333333, 1.16 },
                { 0.9, 0.0275, 0.083, 0.172, 0.13, 3.5, 26, 1.14 },
                { 1, 0.035, 0.085, 0.183, 0.15, 3.5, 24.666666666667, 1.12 },
                { 1.05, 0.0375, 0.0855, 0.199, 0.15, 3.5, 24, 1.11 },
                { 1.1, 0.04, 0.086, 0.215, 0.15, 3.15, 18, 1.1 },
                { 1.2, 0.041, 0.083, 0.2325, 0.25, 2.45, 17, 1.05 },
                { 1.3, 0.04, 0.077, 0.25, 0.35, 1.75, 16, 1 },
                { 1.5, 0.038, 0.062, 0.29, 0.35, 1.5, 13, 0.9 },
                { 1.7, 0.036066666666667, 0.051333333333333, 0.342, 0.210004, 0.9, 12, 0.7 },
                { 1.8, 0.0351, 0.046, 0.368, 0.140006, 0.86, 11.4, 0.64 },
                { 2, 0.033, 0.039, 0.42, 1.0000000000066e-05, 0.78, 10.2, 0.52 },
